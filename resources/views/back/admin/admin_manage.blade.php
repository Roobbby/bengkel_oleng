          ...
          <table class="dt-row-grouping table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$admin->name}}</td>
                    <td>{{$admin->email }}</td>
                    <td><img src="{{ (!empty($admin->foto)) ? url('image/profile/'.$admin->foto) : url('image/default-avatar.png') }}" width="50" alt=""></td>
                    <td>
                      @if ($admin->status == 0)
                    ...
                    <td>
                    <a  data-bs-toggle="modal" data-bs-target="#modal-view{{ $admin->id }}" class="btn btn-sm btn-primary"><i class="ti ti-eye" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="View Data"></i></a>
                    <a href="{{ route('admin.edit', $admin->id) }}" class="btn btn-sm btn-warning"><i class="ti ti-edit" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Edit Data"></i></a>
                    <a data-bs-toggle="modal" data-bs-target="#modal-delete{{ $admin->id }}" class="btn btn-sm btn-danger"><i class="ti ti-trash" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Hapus Data"></i></a>
                    </td>
                    {{-- Modal --}}
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Apakah kamu yakin ingin menghapus data user <b>{{ $admin->name }}</b></p>
                          </div>
