                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('update.password') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                                            <button type="submit"
                                                class="btn btn-primary me-2 waves-effect waves-light">Simpan</button>
                  ...
                  <p>A simple start for everyone</p> --}}
                                            ...
                                            <div class="mb-2 pt-1">
                                                @if ($profileData->expired_date)
                                                    <h6 class="mb-1">Aktif Hingga
                                                        {{ Carbon::parse($profileData->expired_date)->format('d - M - Y ') }}
                                                    </h6>
                    ...
                    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                        <div class="modal-content p-3 p-md-5">
                            <div class="modal-body">
                                ...
                                <form method="POST" action="{{ route('profile.store') }}" id="editUserForm"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                                            ...
                                            <img src="{{ !empty($profileData->foto_profile) ? url('image/profile/' . $profileData->foto_profile) : url('image/default-avatar.png') }}"
                                                alt="profile" class="d-block w-px-100 h-px-100 rounded" id="uploadedAvatar">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="modalEditUserName" name="sapaan" class="form-control"
                                            value="{{ $profileData->sapaan }}" placeholder="Pak,Bu" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Panggilan</label>
                                        <input type="text" id="modalEditUserName" name="panggilan" class="form-control"
                                            value="{{ $profileData->panggilan }}" placeholder="Bud" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Name</label>
                                        <input type="text" id="modalEditName" name="name" class="form-control"
                                            value="{{ $profileData->name }}" placeholder="Budi Handoyo" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Email</label>
                                        <input type="text" id="email" name="email" class="form-control"
                                            value="{{ $profileData->email }}" placeholder="Budi@gmail.cpm" />
                                        <div id="checksEmail"></div>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Gender</label>
                                        <select id="modalEditGender" name="gender" class="select2 form-select">
                                            <option selected="" disabled="">Select Gender</option>
                                            <option value="0" {{ $profileData->gender == '0' ? 'selected' : '' }}>
                                                Laki-Laki</option>
                                            <option value="1" {{ $profileData->gender == '1' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="telp" name="telp"
                                                class="form-control phone-number-mask" value="{{ $profileData->telp }}"
                                                placeholder="0000-0000-0000" pattern="[0-9]*" />
                                        </div>
                        ...
                        success: function(response) {
                            if (response.valid) {
                                $('#password-feedback').html(
                                    '<p class="text-success">Password lama benar.</p>');
                            } else {
                                $('#password-feedback').html(
