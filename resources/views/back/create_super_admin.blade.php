                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" name="username" id="basic-icon-default-fullname"
                                placeholder="Username" aria-label="Username" aria-describedby="basic-icon-default-fullname2"
                                required />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="basic-icon-default-email" class="form-control" name="email"
                                placeholder="Email" aria-label="Email" aria-describedby="basic-icon-default-email2"
                                required />
                        </div>
