            ...
            <div class="card-body">
                <form action="{{ route('user.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                    class="ti ti-user-heart"></i></span>
                            <input type="text" class="form-control" name="panggilan" id="basic-icon-default-fullname"
                                placeholder="Massukan Panggilan" aria-label="Massukan Panggilan"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" name="name" id="basic-icon-default-fullname"
                                placeholder="Massukan Nama" aria-label="Massukan Nama"
                                aria-describedby="basic-icon-default-fullname2" required />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text">+62</span>
                            <input type="text" class="form-control" id="telp" name="telp"
                                placeholder="Massukan Nomer Whatsapp" aria-label="Massukan Whatsapp"
                                aria-describedby="basic-icon-default-fullname2" pattern="[0-9]*" required />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Email"
                                aria-label="Email" aria-describedby="basic-icon-default-email2" required />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="basic-icon-default-key" class="form-control" name="password"
                                placeholder="Password" aria-label="Password" aria-describedby="basic-icon-default-key"
                                required value="123456" readonly />
                        </div>
                    ...
                    <div>
                        <button type="submit"
                            class="btn rounded-pill btn-primary waves-effect waves-light">Tambah</button>
