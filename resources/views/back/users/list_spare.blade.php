                            ...
                            <tbody>
                                @foreach ($product as $products)
                                    <tr class="">
                                        ...
                                        <td> <img src="image/item/{{ $products->cover }}" alt="Barang" class="rounded"
                                                width="100" height="70">
                                        </td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah kamu yakin ingin menghapus
                                                            <b>{{ $products->nama_barang }}</b> ini
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <form action="{{ route('item.destroy', $products->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                        ...
                                        <div class="modal fade" id="modal-view{{ $products->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        </button>
                                                            ...
                                                            <form action="">
                                                                ...
                                                                <div class="d-flex align-items-center flex-column mb-3">
                                                                    ...
                                                                    <img class="img-fluid rounded mb-2 pt-1 mt-4"
                                                                        src="image/item/{{ $products->cover }}"
                                                                        alt="Barang" class="rounded" width="150"
                                                                        height="100" />
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group input-group-merge">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="{{ $products->nama_barang }}" required
                                                                            readonly />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group input-group-merge">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="{{ $products->category }}" required
                                                                            readonly />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group input-group-merge">
                                                                        ...
                                                                        <textarea class="form-control" name="deskripsi" id="basic-icon-default-username" placeholder="alamat bengkel"
                                                                            aria-label="alamat bengkel" required readonly>{!! $products->deskripsi !!}</textarea>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
